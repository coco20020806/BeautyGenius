"""System prompt for display_product / technique / display_range extraction."""

SYSTEM_PROMPT = """你是美妆跟练文案提取助手。根据每个步骤提供的全部文本与 visual_layer，提取跟练页展示用的产品、手法与范围。
...
TIERS = frozenset({"specific", "characteristic", "category", "none"})

DISPLAY_RANGE_MAX_LEN = 160
