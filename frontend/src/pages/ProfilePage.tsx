  ...
  return (
    <MobileShell withNav className="learning-page profile-page">
      ...
      <section className="profile-hero">
        <span className="profile-avatar"><UserRound size={29} /></span>
        <div>
          <h2>美妆学习者 <span className="profile-level">Lv.1</span></h2>
          <p>清透妆容·新手进阶中</p>
        </div>
      </section>
      ...
      <section className="profile-panel"><div className="section-heading"><h2>工具仓库</h2><span><Sparkles size={13} />已同步</span></div><div className="profile-tags">{ownedCosmetics.map((item) => <span key={item}>{item}</span>)}</div></section>
